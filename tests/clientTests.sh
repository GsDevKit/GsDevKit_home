...
createClient -t pharo gciClient50 -s ${STONENAME1} -v Pharo5.0 -z $GS_HOME/shared/repos/GemStone-GCI/.smalltalk.ston
createClient -t pharo gciClient50 -l -s ${STONENAME1} -v Pharo5.0 -z $GS_HOME/shared/repos/GemStone-GCI/.smalltalk.ston
