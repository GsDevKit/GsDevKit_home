...
The ` $GS_HOME/binupgradeStone` script can be used to upgrade from GemStone versions 2.4.4.1 through 2.4.8, 3.1.x, 3.2.x, 3.3.x and beyond to GemStone versions 3.1.0.6, 3.2.x, 3.3.x, 3.4.x and beyond.
...
```
$GS_HOME/bin/upgradeStone -l/home/loadApplication devKit_329 devKit_343 3.4.3 |& tee -a $GS_HOME/upgrade.log
```
...
```
$GS_HOME/bin/upgradeStone -l/home/upgradeApplication devKit_329 devKit_343 3.4.3 |& tee -a $GS_HOME/upgrade.log
```
...
[1]: https://downloads.gemtalksystems.com/docs/GemStone64/3.4.x/GS64-ProgGuide-3.4/GS64-ProgGuide-3.4.htm?https://downloads.gemtalksystems.com/docs/GemStone64/3.4.x/GS64-ProgGuide-3.4/5-Strings.htm
